...
- Renames TEMPLATE_OPENCODE.md → OPENCODE.md
...
### Step 3: Customize OPENCODE.md

```bash
# Rename template to active file
mv TEMPLATE_OPENCODE.md OPENCODE.md
...
- Configured OPENCODE.md for this specific project
...
# ✅ OPENCODE.md customized (no [Fill in:] markers)
grep "\[Fill in:" OPENCODE.md
